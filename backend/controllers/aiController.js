...
export const generateSummary = async (req, res, next) => {
    try {
        ...
        const summary = await ai.generateSummary(document.extractedText)
...
export const chat = async (req, res, next) => {
    try {
        ...
        const answer = await ai.chatWithContext(question, relevantChunks)
...
export const explainConcept = async (req, res, next) => {
    try {
        ...
        const explanation = await ai.explainConcept(concept, context)
