...
const AiActions = () => {
    ...
    const handleGenerateSummary = async () => {
        ...
        try {
            ...
            setModalContent(response?.data?.summary || response?.data || response || "No summary generated")
            setIsModalOpen(true)
        } catch (error) {
    ...
    const handleExplainConcept = async (e) => {
        ...
        try {
            ...
            setModalContent(response?.data?.explanation  || response?.data || response || "No explaining generated")
            setIsModalOpen(true)
            setConcept("")
        } catch (error) {
                    ...
                    <form onSubmit={handleExplainConcept}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className="shrink-0 h-10 px-5 bg-linear-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
                            >
