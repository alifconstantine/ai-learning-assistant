...
// Helper func to format file size
...
const DocumentCards = ({ document, onDelete }) => {
    ...
    return <div className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1" onClick={handleNavigate}>
        ...
        <div>
            ...
            {/* Title */}
            <h3 className="text-base font-medium text-slate-900 truncate mb-2" title={document.title}>
                {document.title}
            </h3>
            ...
            <div className="flex items-center gap-3">
                ...
                {document.quizCount !== undefined && (
                    <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-50 rounded-lg">
                        <BrainCircuit className="w-3.5 h-3.5 text-emerald-700" strokeWidth={2} />
