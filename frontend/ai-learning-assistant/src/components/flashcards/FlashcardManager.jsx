    ...
    return (
        <div className="space-y-8">
            ...
            <button
                ...
                className="group inline-flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-emerald-600 transition-all duration-200"
            >
      ...
      >
        <div className="space-y-6">
            <p className="text-sm text-slate-600">
                Are you sure want to delete this flashcard set? This action cannot be undone and all cards will be permanently removed.
            </p>
