...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  return <div className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col justify-between" onClick={handleStudyNow}>
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 pt-2">
        <div className="px-3 p-1.5 bg-slate-50 border border-slate-200 rounded-lg">
