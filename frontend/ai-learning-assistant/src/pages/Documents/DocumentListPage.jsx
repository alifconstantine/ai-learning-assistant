...
import DocumentCards from "../../components/documents/DocumentCard";
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  onClick={() => setIsUploadModalOpen(false)}
                  disabled={uploading}
                  className="flex-1 h-11 px-4 border-2 border-slate-100 rounded-xl bg-white text-slate-700 text-sm font-semibold hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
                <button
