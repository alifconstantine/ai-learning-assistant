  ...
  return (
    <div className="max-w-5xl mx-auto">
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          {isCorrectOption && (
                            <span className="inline-flex items-center gap-1 px-3 py-1 bg-emerald-100 border border-emerald-300 rounded-lg text-xs font-semibold text-emerald-700">
                              <CheckCircle2 className="w-3 h-3" strokeWidth={2.5}/>
                              Correct
                            </span>
                          )}
                          {isWrongAnswer && (
                            <span className="inline-flex items-center gap-1 px-3 py-1 bg-rose-100 border border-rose-300 rounded-lg text-xs font-semibold text-rose-700">
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/document/${quiz.document._id}`}>
