...
const QuizTakePage = () => {
  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      const formattedAnswers = Object.keys(selectedAnswer).map(questionId => {
        ...
        return {questionIndex, selectedAnswer: answer}
      })
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Question Card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shdaow-slate-200/50 p-6 mb-6 ">
      ...
      <div className="mt-0 flex items-center justify-center gap-2 flex-wrap">
        {quiz.questions.map((_, index) => {
          const isAnsweredQuestion = selectedAnswer.hasOwnProperty(quiz.questions[index]._id)
